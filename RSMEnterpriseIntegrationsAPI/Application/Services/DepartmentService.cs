...
{
    using RSMEnterpriseIntegrationsAPI.Application.DTOs.DepartamentDTOs;
    ...
    public class DepartmentService : IDepartmentService
    {
        ...
        private async Task<Departament> ValidateDepartmentExistence(int id)
        {
